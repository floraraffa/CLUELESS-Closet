...
let CardInteraction = (() => {
    ...
    var CardInteraction = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.pinchGrabAssistSuppressedUntil = 0;
        ...
        getRightPinchInfo() {
            ...
            const center = new vec3((idxPos.x + thbPos.x) * 0.5, (idxPos.y + thbPos.y) * 0.5, (idxPos.z + thbPos.z) * 0.5);
            return {
                center: center,
                distance: distance,
        ...
        suppressPinchGrabAssist(seconds = 0.5) {
        ...
        updatePinchGrabAssist() {
            if (!this.enablePinchGrabAssist)
                return;
            if (getTime() < this.pinchGrabAssistSuppressedUntil)
                return;
            if (!this.rightIndexTip || !this.rightThumbTip)
                return;
            const idxPos = this.rightIndexTip.getTransform().getWorldPosition();
