...
vec2 l9_3=l9_1*stripeScale;
bool l9_4=(float(enableStripes)*1.0)!=0.0;
bool l9_5;
if (l9_4)
{
l9_5=(float((mod(l9_3,Port_Input1_N007)/(Port_Input1_N002+vec2(1.234e-06))).x>stripes)*1.0)!=0.0;
}
else
{
l9_5=l9_4;
...
{
l9_12=clamp(Port_Value2_N001*2.0,0.0,1.0);
}
#else
{
float l9_13;
...
{
l9_13=clamp(dot(l9_7.xyz,vec3(Port_Value2_N001)),0.0,1.0);
}
#else
{
float l9_14;
...
{
l9_15=(1.0-dot(l9_7.xyz,vec3(0.33333001)))*Port_Value2_N001;
}
#else
{
float l9_16;
...
{
l9_16=(1.0-clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N001;
}
#else
{
float l9_17;
...
{
l9_17=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_18;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_19=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_20;
...
{
l9_20=dot(l9_7.xyz,vec3(0.33333001))*Port_Value2_N001;
}
#else
{
float l9_21;
...
{
l9_27=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_26,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_27=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_26,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_25=l9_27;
}
#endif
vec3 l9_28=mix(l9_25.xyz,definedBlend(l9_25.xyz,l9_7.xyz).xyz,vec3(Port_Value2_N001));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_33=vec4(mix(vec3(1.0),l9_7.xyz,vec3(Port_Value2_N001)),Port_Value2_N001);
}
#else
{
vec4 l9_34;
...
{
l9_35=clamp(Port_Value2_N001,0.0,1.0);
}
#else
{
l9_35=Port_Value2_N001;
}
#endif
...
vec4 l9_38=sc_OutputMotionVectorIfNeeded(max(l9_36,vec4(0.0)));
