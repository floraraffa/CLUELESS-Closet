...
#endif
sc_writeFragData0(max(l9_498,vec4(0.0)));
return;
}
vec4 l9_500;
#if (sc_ProjectiveShadowsCaster)
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_530-0.0039215689)),min(1.0,l9_530+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_532),packValue(l9_532),packValue(l9_532),packValue(l9_532)));
}
#endif
}
#else
...
sc_writeFragData0(l9_529);
}
#endif
}
#else
{
sc_writeFragData0(l9_528);
}
#endif
}
#endif
