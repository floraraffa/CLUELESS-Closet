...
vec3 l9_12=-l9_1;
float l9_13=max(pow(1.0-abs(dot(l9_12,l9_11*Port_Normal_N000)),Port_Exponent_N000),0.0)*alpha;
vec4 l9_14=vec4(l9_13);
...
vec4 l9_45=sc_OutputMotionVectorIfNeeded(max(l9_43,vec4(0.0)));
