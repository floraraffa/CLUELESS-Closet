...
vec4 l9_11=Tweak_N119+vec4(max(pow(1.0-abs(dot(-l9_1,mat3(l9_4,l9_2,l9_3)*Port_Normal_N041)),Tweak_N1),0.0)*Tweak_N8);
...
{
l9_18=clamp(dot(l9_12.xyz,vec3(alpha)),0.0,1.0);
}
#else
{
float l9_19;
...
{
l9_20=(1.0-dot(l9_12.xyz,vec3(0.33333001)))*alpha;
}
#else
{
float l9_21;
...
{
l9_21=(1.0-clamp(dot(l9_12.xyz,vec3(1.0)),0.0,1.0))*alpha;
}
#else
{
float l9_22;
...
{
l9_22=clamp(dot(l9_12.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_23;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_24=clamp(dot(l9_12.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_25;
...
{
l9_25=dot(l9_12.xyz,vec3(0.33333001))*alpha;
}
#else
{
float l9_26;
...
{
l9_32=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_31,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_32=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_31,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_30=l9_32;
}
#endif
vec3 l9_33=mix(l9_30.xyz,definedBlend(l9_30.xyz,l9_12.xyz).xyz,vec3(alpha));
...
#if (sc_Voxelization)
{
l9_35=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_36;
#if (sc_OutputBounds)
{
float l9_37=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_36=vec4(l9_37,1.0-l9_37,1.0,1.0);
}
#else
{
vec4 l9_38;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_38=vec4(mix(vec3(1.0),l9_12.xyz,vec3(alpha)),alpha);
}
#else
{
vec4 l9_39;
...
vec4 l9_43=sc_OutputMotionVectorIfNeeded(max(l9_41,vec4(0.0)));
