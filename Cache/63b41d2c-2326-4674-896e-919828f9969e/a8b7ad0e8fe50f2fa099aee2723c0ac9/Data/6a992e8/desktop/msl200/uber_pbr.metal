...
//float2 Port_resolution_N000 4384
//float depthRef 4392
//}
...
float3 N0_getResolution(thread float2& N0_resolution)
{
if (N0_resolution.x==0.0)
{
return float3(640.0,640.0,1.0);
}
return float3(N0_resolution,1.0);
}
...
{
main_frag_out out={};
float4 N0_fragColor=float4(0.0);
float2 N0_resolution=float2(0.0);
...
float4 fragColor_N0=float4(0.0);
float2 param_2=(*sc_set0.UserUniforms).Port_resolution_N000;
ssGlobals param_3=Globals;
ssGlobals tempGlobals=param_3;
float4 param_1=float4(0.0);
N0_resolution=param_2;
float2 l9_1=tempGlobals.Surface_UVCoord0;
float2 l9_2=l9_1*N0_getResolution(N0_resolution).xy;
float l9_3=tempGlobals.gTimeElapsed;
float l9_4=(l9_3*0.5)+23.0;
float2 l9_5=l9_2/N0_getResolution(N0_resolution).xy;
float2 l9_6=mod(l9_5*6.2831855,float2(6.2831855))-float2(250.0);
float2 l9_7=float2(l9_6);
float l9_8=1.0;
float l9_9=0.0049999999;
int l9_10=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_10<5)
{
float l9_11=l9_4*(1.0-(3.5/float(l9_10+1)));
l9_7=l9_6+float2(cos(l9_11-l9_7.x)+sin(l9_11+l9_7.y),sin(l9_11-l9_7.y)+cos(l9_11+l9_7.x));
l9_8+=(1.0/length(float2(l9_6.x/(sin(l9_7.x+l9_11)/l9_9),l9_6.y/(cos(l9_7.y+l9_11)/l9_9))));
l9_10++;
continue;
}
else
...
{
l9_14=pow(l9_12,l9_13);
}
float l9_15=l9_14;
l9_8=1.17-l9_15;
float l9_16=abs(l9_8);
float l9_17=8.0;
float l9_18;
if (l9_16<=0.0)
{
...
{
l9_18=pow(l9_16,l9_17);
}
float l9_19=l9_18;
float3 l9_20=float3(l9_19);
l9_20=fast::clamp(l9_20+float3(0.0,0.34999999,0.5),float3(0.0),float3(1.0));
N0_fragColor=float4(l9_20,1.0);
param_1=N0_fragColor;
fragColor_N0=param_1;
FinalColor=fragColor_N0;
...
float4 l9_24=fast::max(param_5,float4(0.0));
float4 param_6=l9_24;
if (sc_ShaderCacheConstant_tmp!=0)
{
