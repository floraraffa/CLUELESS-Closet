...
let CollectionManager = (() => {
    ...
    var CollectionManager = _classThis = class extends _classSuper {
        ...
        triggerCombineLook(cardIndex, data, cardReviewText, source) {
            ...
            if (cardReviewText)
                cardReviewText.text = (0, Localization_1.t)('composing_outfit_ai');
            this.enterGarmentOutfitMode();
            this.showOutfitBuilderContainer();
            this.composeOutfitWithAI(cardIndex);
        }
        ...
        composeOutfitDeterministic(preferredIndex = -1) {
            this.resetOutfitTesterSlots();
         ...
         */
        async composeOutfitWithAI(preferredIndex = -1) {
            ...
            try {
                ...
                if (count === 0) {
                    ...
                    this.composeOutfitDeterministic(preferredIndex);
                    return;
                }
                this.showOutfitBuilderContainer();
