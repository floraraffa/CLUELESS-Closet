...
export class CollectionManager extends BaseScriptComponent {
    ...
    private composeOutfitDeterministic(): void {
        this.resetOutfitTesterSlots();
    ...
    private getOutfitSlotAliases(slotIndex: number): string[] {
        ...
        if (slotIndex === 4) return ['photocard TOP 2', 'PhotoCard TOP 2', 'Photocard TOP 2', 'Photo Card TOP 2', 'photocard TOP2', 'photocard LAYER', 'photocard OUTERWEAR', 'Garment LAYER', 'TOP 2', 'TOP2', 'Layer', 'Outerwear', 'Jacket'];
        return [];
    }
