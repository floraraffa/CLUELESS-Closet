...
#endif
sc_writeFragData0(max(l9_182,vec4(0.0)));
return;
}
vec4 l9_184;
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_214-0.0039215689)),min(1.0,l9_214+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_216),packValue(l9_216),packValue(l9_216),packValue(l9_216)));
}
#endif
}
#else
