...
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Storage buckets and folder paths for video and audio</span>"}
...
// @ui {"widget":"separator"}
// @ui {"widget":"label", "label":"<span style=\"color: #60A5FA;\">Social Sharing Configuration</span>"}
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Snapchat Spotlight sharing options and caption settings</span>"}
...
// @ui {"widget":"separator"}
// @ui {"widget":"label", "label":"<span style=\"color: #60A5FA;\">Video Format Configuration</span>"}
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Image format, quality, and aspect ratio settings</span>"}
...
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Camera service and texture source selection</span>"}
...
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Microphone and audio recording settings</span>"}
...
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Button, switch, status display, and preview components</span>"}
...
var Module = require("../../../../../../Modules/Src/Packages/SnapCloudExamples.lspkg/Example5-Media/Scripts/CompositeCaptureUploader");
