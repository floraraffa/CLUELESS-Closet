...
float l9_85=l9_4.w*masterAlpha;
vec4 l9_86=vec4(l9_4.xyz,l9_85);
#if (sc_BlendMode_AlphaTest)
{
if (l9_85<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_85<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_87,vec4(0.0)));
return;
}
vec4 l9_89;
...
{
l9_92=clamp(dot(l9_86.xyz,vec3(l9_85)),0.0,1.0);
}
#else
{
float l9_93;
...
{
l9_94=(1.0-dot(l9_86.xyz,vec3(0.33333001)))*l9_85;
}
#else
{
float l9_95;
...
{
l9_95=(1.0-clamp(dot(l9_86.xyz,vec3(1.0)),0.0,1.0))*l9_85;
}
#else
{
float l9_96;
...
{
l9_96=clamp(dot(l9_86.xyz,vec3(1.0)),0.0,1.0)*l9_85;
}
#else
{
float l9_97;
#if (sc_BlendMode_Add)
{
l9_97=clamp(dot(l9_86.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_98;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_98=clamp(dot(l9_86.xyz,vec3(1.0)),0.0,1.0)*l9_85;
}
#else
{
float l9_99;
...
{
l9_99=dot(l9_86.xyz,vec3(0.33333001))*l9_85;
}
#else
{
float l9_100;
#if (sc_BlendMode_Min)
{
l9_100=1.0-clamp(dot(l9_86.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_101;
#if (sc_BlendMode_Max)
{
l9_101=clamp(dot(l9_86.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_101=1.0;
...
#endif
l9_89=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_86.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_90);
}
#else
{
vec4 l9_102;
...
{
l9_106=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_105,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_106=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_105,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_104=l9_106;
}
#endif
vec3 l9_107=mix(l9_104.xyz,definedBlend(l9_104.xyz,l9_86.xyz).xyz,vec3(l9_85));
vec4 l9_108=vec4(l9_107.x,l9_107.y,l9_107.z,vec4(0.0).w);
l9_108.w=1.0;
l9_103=l9_108;
}
#else
...
#if (sc_Voxelization)
{
l9_109=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_110;
#if (sc_OutputBounds)
{
float l9_111=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_110=vec4(l9_111,1.0-l9_111,1.0,1.0);
}
#else
{
vec4 l9_112;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_112=vec4(mix(vec3(1.0),l9_86.xyz,vec3(l9_85)),l9_85);
}
#else
{
vec4 l9_113;
...
#endif
l9_113=vec4(l9_86.xyz*l9_114,l9_114);
}
#else
{
l9_113=l9_86;
...
vec4 l9_117=sc_OutputMotionVectorIfNeeded(max(l9_115,vec4(0.0)));
...
#endif
int l9_121=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_120).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_133).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_138==0)
{
l9_141=texture(sc_OITAlpha0,l9_133);
l9_140=texture(sc_OITDepthLow0,l9_133);
l9_139=texture(sc_OITDepthHigh0,l9_133);
}
else
{
l9_141=vec4(0.0);
...
if (l9_138==1)
{
l9_144=texture(sc_OITAlpha1,l9_133);
l9_143=texture(sc_OITDepthLow1,l9_133);
l9_142=texture(sc_OITDepthHigh1,l9_133);
}
else
{
l9_144=l9_141;
...
vec4 l9_159=texture(sc_OITFilteredDepthBoundsTexture,l9_133);
