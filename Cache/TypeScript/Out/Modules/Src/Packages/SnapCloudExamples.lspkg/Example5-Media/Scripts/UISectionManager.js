...
exports.UISectionManager = void 0;
var __selfType = requireType("./UISectionManager");
...
let UISectionManager = (() => {
    let _classDecorators = [component];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = BaseScriptComponent;
    var UISectionManager = _classThis = class extends _classSuper {
        constructor() {
            super();
            this.toggleGroup = this.toggleGroup;
            this.uiSections = this.uiSections;
            this.defaultSectionIndex = this.defaultSectionIndex;
         ...
         */
        getToggleIndex(selectedToggleable) {
            try {
                ...
                else if (toggleName.includes("ButtonSharing") ||
         ...
         */
        switchToSectionManually(sectionIndex) {
    ...
    __setFunctionName(_classThis, "UISectionManager");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        UISectionManager = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UISectionManager = _classThis;
})();
exports.UISectionManager = UISectionManager;
//# sourceMappingURL=UISectionManager.js.map