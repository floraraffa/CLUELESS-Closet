...
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Centralized Supabase project settings for Example5-Media</span>"}
// @input Asset.SupabaseProject supabaseProject {"hint":"SupabaseProject asset from Asset Browser (created via Supabase Plugin)"}
// @ui {"widget":"separator"}
// @ui {"widget":"label", "label":"<span style=\"color: #60A5FA;\">Warning Configuration</span>"}
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Setup instructions and validation warnings</span>"}
...
var Module = require("../../../../../../Modules/Src/Packages/SnapCloudExamples.lspkg/Example5-Media/Scripts/SnapCloudRequirements");
