...
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Realtime channel settings for composite streaming</span>"}
...
// @ui {"widget":"separator"}
// @ui {"widget":"label", "label":"<span style=\"color: #60A5FA;\">Video Configuration</span>"}
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Video quality, frame rate, and resolution settings</span>"}
...
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Microphone and audio streaming settings</span>"}
...
var Module = require("../../../../../../Modules/Src/Packages/SnapCloudExamples.lspkg/Example5-Media/Scripts/CompositeStreamingController");
