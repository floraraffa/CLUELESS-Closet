...
// @ui {"widget":"separator"}
// @ui {"widget":"label", "label":"<span style=\"color: #60A5FA;\">Storage Configuration</span>"}
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Supabase Storage bucket and asset file paths</span>"}
...
// @ui {"widget":"separator"}
// @ui {"widget":"label", "label":"<span style=\"color: #60A5FA;\">Asset Files</span>"}
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Filenames for 3D models, images, and audio in storage</span>"}
...
var Module = require("../../../../../Modules/Src/Packages/SnapCloudExamples.lspkg/Example3-Storage/StorageLoader");
