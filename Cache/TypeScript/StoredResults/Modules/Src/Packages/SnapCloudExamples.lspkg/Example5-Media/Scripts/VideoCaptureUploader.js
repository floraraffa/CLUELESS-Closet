...
exports.VideoCaptureUploader = void 0;
var __selfType = requireType("./VideoCaptureUploader");
 ...
 */
let VideoCaptureUploader = (() => {
    let _classDecorators = [component];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = BaseScriptComponent;
    var VideoCaptureUploader = _classThis = class extends _classSuper {
        constructor() {
            super();
            ...
            this.captureFrameRate = this.captureFrameRate; // Default to MAX for best results
            this.useHighQuality = this.useHighQuality;
            ...
            this.isUploadingSession = false; // Prevents new recording while uploading
            this.sessionId = "";
            this.frameCount = 0;
            ...
            this.frameRegistration = null; // Registration for onNewFrame callback
            // Performance tracking
            this.activeEncodes = 0;
            this.framesSkipped = 0;
            this.uploadedCount = 0;
            this.textureZeroCount = 0; // Track 0x0 texture occurrences
            this.encodeFailCount = 0; // Track encoding failures
        ...
        async startRecording() {
            ...
            this.maxDurationEvent = this.createEvent("DelayedCallbackEvent");
         ...
         */
        async encodeAndQueueFrame(texture, frameNumber, timestamp) {
            try {
         ...
         */
        async uploadFrame(frameNumber, data, timestamp) {
            try {
        ...
        async stopRecording() {
            ...
            if (actualFPS < targetFPS * 0.9) {
                this.log(` TIP: Device captured ${actualFPS.toFixed(1)} FPS. Consider setting Capture Frame Rate to ${Math.floor(actualFPS)} for optimal results.`);
            }
    ...
    __setFunctionName(_classThis, "VideoCaptureUploader");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        VideoCaptureUploader = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return VideoCaptureUploader = _classThis;
})();
exports.VideoCaptureUploader = VideoCaptureUploader;
//# sourceMappingURL=VideoCaptureUploader.js.map