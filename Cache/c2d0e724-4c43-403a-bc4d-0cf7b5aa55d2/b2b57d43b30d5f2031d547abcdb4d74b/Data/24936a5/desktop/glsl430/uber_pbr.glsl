...
#endif
sc_writeFragData0(max(l9_514,vec4(0.0)));
return;
}
vec4 l9_516;
#if (sc_ProjectiveShadowsCaster)
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_546-0.0039215689)),min(1.0,l9_546+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_548),packValue(l9_548),packValue(l9_548),packValue(l9_548)));
}
#endif
}
#else
...
sc_writeFragData0(l9_545);
}
#endif
}
#else
{
sc_writeFragData0(l9_544);
}
#endif
}
#endif
