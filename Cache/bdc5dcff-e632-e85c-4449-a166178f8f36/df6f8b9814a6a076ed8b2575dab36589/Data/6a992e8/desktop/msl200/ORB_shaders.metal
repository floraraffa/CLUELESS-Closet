...
//sampler sampler Tweak_N15SmpSC 0:26
//sampler sampler Tweak_N18SmpSC 0:27
//sampler sampler Tweak_N82SmpSC 0:28
...
//texture texture2D Tweak_N0 0:4:0:25
//texture texture2D Tweak_N15 0:5:0:26
//texture texture2D Tweak_N18 0:6:0:27
//texture texture2D Tweak_N82 0:7:0:28
//texture texture2D intensityTexture 0:8:0:29
...
//}
//ubo int UserUniforms 0:39:5200 {
//float4 sc_Time 1376
...
//float Tweak_N16 4528
//float4 Tweak_N68 4544
//float3x3 Tweak_N18Transform 4608
//float4 Tweak_N18UvMinMax 4656
//float4 Tweak_N18BorderColor 4672
//float Tweak_N17 4688
//float3x3 Tweak_N15Transform 4752
//float4 Tweak_N15UvMinMax 4800
//float4 Tweak_N15BorderColor 4816
//float3x3 Tweak_N82Transform 4880
//float4 Tweak_N82UvMinMax 4928
//float4 Tweak_N82BorderColor 4944
//float Tweak_N24 4960
//float3 Port_Default_N052 4976
//float4 Port_Value0_N067 4992
//float4 Port_Default_N067 5008
//float3 Port_Default_N065 5024
//float4 Port_Default_N023 5040
//float3 Port_Input1_N042 5056
//float Port_Input1_N264 5088
//float Port_Input1_N268 5092
//float Port_Input1_N270 5096
//float4 Port_Default_N083 5104
//float3 Port_Default_N062 5120
//float3 Port_Input2_N013 5136
//float Port_Bool1_N029 5152
//float4 Port_Value1_N029 5168
//float depthRef 5184
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N15 32 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N18 33 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N82 34 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 35 0
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N0 36 0
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N15 37 0
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N18 38 0
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N82 39 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 40 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N0 41 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N15 42 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N18 43 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N82 44 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 45 0
//spec_const bool Tweak_N0HasSwappedViews 46 0
//spec_const bool Tweak_N104 47 0
//spec_const bool Tweak_N15HasSwappedViews 48 0
//spec_const bool Tweak_N18HasSwappedViews 49 0
//spec_const bool Tweak_N20 50 0
//spec_const bool Tweak_N22 51 0
//spec_const bool Tweak_N28 52 0
//spec_const bool Tweak_N34 53 0
//spec_const bool Tweak_N64 54 0
//spec_const bool Tweak_N82HasSwappedViews 55 0
...
//spec_const int NODE_66_DROPLIST_ITEM 89 0
//spec_const int SC_DEVICE_CLASS 90 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N0 91 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N15 92 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N18 93 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N82 94 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 95 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N0 96 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N15 97 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N18 98 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N82 99 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 100 -1
//spec_const int Tweak_N0Layout 101 0
//spec_const int Tweak_N15Layout 102 0
//spec_const int Tweak_N18Layout 103 0
//spec_const int Tweak_N82Layout 104 0
...
constant bool SC_USE_CLAMP_TO_BORDER_Tweak_N15 [[function_constant(32)]];
...
constant bool SC_USE_CLAMP_TO_BORDER_Tweak_N18 [[function_constant(33)]];
...
constant bool SC_USE_CLAMP_TO_BORDER_Tweak_N82 [[function_constant(34)]];
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N0 [[function_constant(36)]];
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N15 [[function_constant(37)]];
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N18 [[function_constant(38)]];
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N82 [[function_constant(39)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N0 [[function_constant(41)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N15 [[function_constant(42)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N18 [[function_constant(43)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N82 [[function_constant(44)]];
...
constant bool Tweak_N0HasSwappedViews [[function_constant(46)]];
...
constant bool Tweak_N104 [[function_constant(47)]];
constant bool Tweak_N104_tmp = is_function_constant_defined(Tweak_N104) ? Tweak_N104 : false;
constant bool Tweak_N15HasSwappedViews [[function_constant(48)]];
...
constant bool Tweak_N18HasSwappedViews [[function_constant(49)]];
...
constant bool sc_OutputBounds [[function_constant(79)]];
...
constant bool sc_RayTracingCasterForceOpaque [[function_constant(82)]];
...
constant int NODE_66_DROPLIST_ITEM [[function_constant(89)]];
constant int NODE_66_DROPLIST_ITEM_tmp = is_function_constant_defined(NODE_66_DROPLIST_ITEM) ? NODE_66_DROPLIST_ITEM : 0;
constant int SC_DEVICE_CLASS [[function_constant(90)]];
constant int SC_DEVICE_CLASS_tmp = is_function_constant_defined(SC_DEVICE_CLASS) ? SC_DEVICE_CLASS : -1;
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N0 [[function_constant(91)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N15 [[function_constant(92)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N18 [[function_constant(93)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N82 [[function_constant(94)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N0 [[function_constant(96)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N15 [[function_constant(97)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N18 [[function_constant(98)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N82 [[function_constant(99)]];
...
constant int sc_DepthBufferMode [[function_constant(106)]];
...
float3 Port_Input2_N013;
float Port_Bool1_N029;
float4 Port_Value1_N029;
float depthRef;
};
struct sc_Bone_t
{
...
texture2d<float> Tweak_N15 [[id(5)]];
texture2d<float> Tweak_N18 [[id(6)]];
texture2d<float> Tweak_N82 [[id(7)]];
texture2d<float> intensityTexture [[id(8)]];
...
sampler Tweak_N0SmpSC [[id(25)]];
sampler Tweak_N15SmpSC [[id(26)]];
sampler Tweak_N18SmpSC [[id(27)]];
sampler Tweak_N82SmpSC [[id(28)]];
...
{
float l9_88=0.0;
float l9_89=(*sc_set0.UserUniforms).Tweak_N16;
l9_88=l9_89;
float4 l9_90=float4(0.0);
float4 l9_91=(*sc_set0.UserUniforms).Port_Value0_N067;
float4 l9_92=float4(0.0);
float4 l9_93=float4(0.0);
float4 l9_94=(*sc_set0.UserUniforms).Port_Default_N067;
ssGlobals l9_95=param_9;
float4 l9_96;
...
float4 l9_98=(*sc_set0.UserUniforms).Tweak_N68;
l9_97=l9_98;
l9_92=l9_97;
l9_96=l9_92;
}
...
int l9_105=l9_100;
int l9_106=Tweak_N0Layout_tmp;
int l9_107=l9_105;
float2 l9_108=l9_95.Surface_UVCoord0;
bool l9_109=(int(SC_USE_UV_TRANSFORM_Tweak_N0_tmp)!=0);
float3x3 l9_110=(*sc_set0.UserUniforms).Tweak_N0Transform;
int2 l9_111=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0_tmp);
bool l9_112=(int(SC_USE_UV_MIN_MAX_Tweak_N0_tmp)!=0);
float4 l9_113=(*sc_set0.UserUniforms).Tweak_N0UvMinMax;
bool l9_114=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0_tmp)!=0);
float4 l9_115=(*sc_set0.UserUniforms).Tweak_N0BorderColor;
float l9_116=0.0;
...
float4 l9_183=sc_set0.Tweak_N0.sample(sc_set0.Tweak_N0SmpSC,l9_182.xy,bias(l9_176));
...
float3 l9_188=(*sc_set0.UserUniforms).Port_Default_N065;
ssGlobals l9_189=param_9;
float3 l9_190;
...
int l9_197=l9_192;
int l9_198=Tweak_N18Layout_tmp;
int l9_199=l9_197;
float2 l9_200=l9_189.Surface_UVCoord0;
bool l9_201=(int(SC_USE_UV_TRANSFORM_Tweak_N18_tmp)!=0);
float3x3 l9_202=(*sc_set0.UserUniforms).Tweak_N18Transform;
int2 l9_203=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N18_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N18_tmp);
bool l9_204=(int(SC_USE_UV_MIN_MAX_Tweak_N18_tmp)!=0);
float4 l9_205=(*sc_set0.UserUniforms).Tweak_N18UvMinMax;
bool l9_206=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N18_tmp)!=0);
float4 l9_207=(*sc_set0.UserUniforms).Tweak_N18BorderColor;
float l9_208=0.0;
...
float4 l9_275=sc_set0.Tweak_N18.sample(sc_set0.Tweak_N18SmpSC,l9_274.xy,bias(l9_268));
...
l9_278=(float4(l9_88)*l9_90)*float4(l9_186,0.0);
float4 l9_279=float4(0.0);
float4 l9_280=l9_278;
float4 l9_281;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_281=float4(pow(l9_280.x,2.2),pow(l9_280.y,2.2),pow(l9_280.z,2.2),pow(l9_280.w,2.2));
}
else
{
l9_281=l9_280*l9_280;
}
...
ssGlobals l9_286=param_9;
float4 l9_287;
if ((int(Tweak_N104_tmp)!=0))
{
float3 l9_288=float3(0.0);
l9_288=l9_286.VertexNormal_WorldSpace;
float3 l9_289=float3(0.0);
l9_289=-l9_286.ViewDirWS;
float l9_290=0.0;
l9_290=dot(l9_288,l9_289);
float l9_291=0.0;
l9_291=abs(l9_290);
l9_284=float4(l9_291);
l9_287=l9_284;
}
else
{
float3 l9_292=float3(0.0);
l9_292=l9_286.VertexNormal_WorldSpace;
float3 l9_293=float3(0.0);
l9_293=-l9_286.ViewDirWS;
float l9_294=0.0;
l9_294=dot(l9_292,l9_293);
float l9_295=0.0;
l9_295=abs(l9_294);
float l9_296=0.0;
l9_296=1.0-l9_295;
l9_285=float4(l9_296);
l9_287=l9_285;
}
l9_283=l9_287;
float l9_297=0.0;
float l9_298=(*sc_set0.UserUniforms).Tweak_N17;
l9_297=l9_298;
...
{
l9_306=pow(l9_283.w,l9_297);
}
l9_299=float4(l9_301,l9_303,l9_305,l9_306);
float4 l9_307=float4(0.0);
l9_307=l9_279*l9_299;
param_6=l9_307;
param_8=param_6;
}
else
...
{
float3 l9_308=float3(0.0);
l9_308=param_13.ViewDirWS;
float3 l9_309=float3(0.0);
l9_309=param_13.VertexNormal_WorldSpace;
float3 l9_310=float3(0.0);
l9_310=reflect(l9_308,l9_309);
float3 l9_311=float3(0.0);
l9_311=l9_310*(*sc_set0.UserUniforms).Port_Input1_N042;
float3 l9_312=float3(0.0);
l9_312=l9_311;
float2 l9_313=float2(0.0);
l9_313=float2(l9_312.x,l9_312.y);
float l9_314=0.0;
float l9_315=0.0;
float l9_316=0.0;
float3 l9_317=l9_312;
float l9_318=l9_317.x;
float l9_319=l9_317.y;
float l9_320=l9_317.z;
l9_314=l9_318;
l9_315=l9_319;
l9_316=l9_320;
float l9_321=0.0;
l9_321=l9_314*l9_314;
float l9_322=0.0;
l9_322=l9_315*l9_315;
float l9_323=0.0;
l9_323=l9_316+(*sc_set0.UserUniforms).Port_Input1_N264;
float l9_324=0.0;
l9_324=l9_323*l9_323;
float l9_325=0.0;
l9_325=(l9_321+l9_322)+l9_324;
float l9_326=0.0;
float l9_327;
if (l9_325<=0.0)
{
...
l9_326=l9_327;
float l9_328=0.0;
l9_328=l9_326*(*sc_set0.UserUniforms).Port_Input1_N268;
float2 l9_329=float2(0.0);
l9_329=l9_313/float2(l9_328);
float2 l9_330=float2(0.0);
l9_330=l9_329+float2((*sc_set0.UserUniforms).Port_Input1_N270);
float2 l9_331=float2(0.0);
l9_331=float2(1.0)-l9_330;
...
int l9_339=l9_334;
int l9_340=Tweak_N15Layout_tmp;
int l9_341=l9_339;
float2 l9_342=l9_332;
bool l9_343=(int(SC_USE_UV_TRANSFORM_Tweak_N15_tmp)!=0);
float3x3 l9_344=(*sc_set0.UserUniforms).Tweak_N15Transform;
int2 l9_345=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N15_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N15_tmp);
bool l9_346=(int(SC_USE_UV_MIN_MAX_Tweak_N15_tmp)!=0);
float4 l9_347=(*sc_set0.UserUniforms).Tweak_N15UvMinMax;
bool l9_348=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N15_tmp)!=0);
float4 l9_349=(*sc_set0.UserUniforms).Tweak_N15BorderColor;
float l9_350=0.0;
...
float4 l9_417=sc_set0.Tweak_N15.sample(sc_set0.Tweak_N15SmpSC,l9_416.xy,bias(l9_410));
...
float4 l9_422=(*sc_set0.UserUniforms).Port_Default_N083;
ssGlobals l9_423=param_13;
float4 l9_424;
...
int l9_431=l9_426;
int l9_432=Tweak_N82Layout_tmp;
int l9_433=l9_431;
float2 l9_434=l9_423.Surface_UVCoord0;
bool l9_435=(int(SC_USE_UV_TRANSFORM_Tweak_N82_tmp)!=0);
float3x3 l9_436=(*sc_set0.UserUniforms).Tweak_N82Transform;
int2 l9_437=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N82_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N82_tmp);
bool l9_438=(int(SC_USE_UV_MIN_MAX_Tweak_N82_tmp)!=0);
float4 l9_439=(*sc_set0.UserUniforms).Tweak_N82UvMinMax;
bool l9_440=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N82_tmp)!=0);
float4 l9_441=(*sc_set0.UserUniforms).Tweak_N82BorderColor;
float l9_442=0.0;
bool l9_443=l9_440&&(!l9_438);
float l9_444=1.0;
float l9_445=l9_434.x;
int l9_446=l9_437.x;
if (l9_446==1)
{
l9_445=fract(l9_445);
...
if (l9_446==2)
{
float l9_447=fract(l9_445);
float l9_448=l9_445-l9_447;
float l9_449=step(0.25,fract(l9_448*0.5));
l9_445=mix(l9_447,1.0-l9_447,fast::clamp(l9_449,0.0,1.0));
}
}
l9_434.x=l9_445;
float l9_450=l9_434.y;
int l9_451=l9_437.y;
if (l9_451==1)
{
l9_450=fract(l9_450);
...
float l9_457=l9_434.x;
float l9_458=l9_439.x;
float l9_459=l9_439.z;
bool l9_460=l9_456;
float l9_461=l9_444;
...
float l9_466=l9_434.y;
float l9_467=l9_439.y;
float l9_468=l9_439.w;
bool l9_469=l9_465;
float l9_470=l9_444;
...
float2 l9_473=l9_434;
bool l9_474=l9_435;
float3x3 l9_475=l9_436;
if (l9_474)
{
l9_473=float2((l9_475*float3(l9_473,1.0)).xy);
}
float2 l9_476=l9_473;
l9_434=l9_476;
float l9_477=l9_434.x;
int l9_478=l9_437.x;
bool l9_479=l9_443;
float l9_480=l9_444;
if ((l9_478==0)||(l9_478==3))
{
float l9_481=l9_477;
float l9_482=0.0;
float l9_483=1.0;
...
l9_434.y=l9_488;
l9_444=l9_491;
float2 l9_499=l9_434;
int l9_500=l9_432;
int l9_501=l9_433;
float l9_502=l9_442;
float2 l9_503=l9_499;
int l9_504=l9_500;
int l9_505=l9_501;
float3 l9_506=float3(0.0);
if (l9_504==0)
{
l9_506=float3(l9_503,0.0);
}
else
{
if (l9_504==1)
{
l9_506=float3(l9_503.x,(l9_503.y*0.5)+(0.5-(float(l9_505)*0.5)),0.0);
}
else
{
l9_506=float3(l9_503,float(l9_505));
}
}
float3 l9_507=l9_506;
float3 l9_508=l9_507;
float4 l9_509=sc_set0.Tweak_N82.sample(sc_set0.Tweak_N82SmpSC,l9_508.xy,bias(l9_502));
float4 l9_510=l9_509;
if (l9_440)
{
l9_510=mix(l9_441,l9_510,float4(l9_444));
}
...
l9_512=l9_333*l9_420;
float4 l9_513=float4(0.0);
float4 l9_514=l9_512;
float4 l9_515;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_515=float4(pow(l9_514.x,2.2),pow(l9_514.y,2.2),pow(l9_514.z,2.2),pow(l9_514.w,2.2));
}
else
{
l9_515=l9_514*l9_514;
}
float4 l9_516=l9_515;
l9_513=l9_516;
float l9_517=0.0;
float l9_518=(*sc_set0.UserUniforms).Tweak_N24;
l9_517=l9_518;
float4 l9_519=float4(0.0);
l9_519=l9_513*float4(l9_517);
param_10=l9_519.xyz;
param_12=param_10;
}
else
...
Output_N13=(Result_N23.xyz+Result_N62)+(*sc_set0.UserUniforms).Port_Input2_N013;
float3 Output_N108=float3(0.0);
float3 param_14=Output_N13;
float3 l9_520;
if (SC_DEVICE_CLASS_tmp>=2)
{
l9_520=float3(pow(param_14.x,0.45454544),pow(param_14.y,0.45454544),pow(param_14.z,0.45454544));
}
else
{
l9_520=sqrt(param_14);
}
...
float param_15=(*sc_set0.UserUniforms).Port_Bool1_N029;
float4 param_16=(*sc_set0.UserUniforms).Port_Value1_N029;
...
float4 l9_523=(*sc_set0.UserUniforms).Tweak_N1;
l9_522=l9_523;
float l9_524=0.0;
l9_524=l9_522.w;
param_17=float4(l9_524);
param_18=param_17;
}
Result_N29=param_18;
...
{
float4 l9_525=gl_FragCoord;
float2 l9_526=floor(mod(l9_525.xy,float2(4.0)));
float l9_527=(mod(dot(l9_526,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_19<l9_527)
{
discard_fragment();
}
...
float4 l9_528=fast::max(param_20,float4(0.0));
float4 param_21=l9_528;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_531=fast::clamp(l9_530.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_531=fast::clamp(dot(l9_530.xyz,float3(l9_530.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_531=(1.0-dot(l9_530.xyz,float3(0.33333001)))*l9_530.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_531=(1.0-fast::clamp(dot(l9_530.xyz,float3(1.0)),0.0,1.0))*l9_530.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_531=fast::clamp(dot(l9_530.xyz,float3(1.0)),0.0,1.0)*l9_530.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_531=fast::clamp(dot(l9_530.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_531=dot(l9_530.xyz,float3(0.33333001))*l9_530.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_531=1.0-fast::clamp(dot(l9_530.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_532=l9_531;
float l9_533=l9_532;
float l9_534=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_533;
float3 l9_535=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_529.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_536=float4(l9_535.x,l9_535.y,l9_535.z,l9_534);
param_22=l9_536;
}
else
{
...
{
float4 l9_537=param_22;
float4 l9_538=float4(0.0);
float4 l9_539=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_540=out.sc_FragData0;
l9_539=l9_540;
}
else
{
float4 l9_541=gl_FragCoord;
float2 l9_542=l9_541.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_547=l9_546;
int l9_548=l9_547;
float3 l9_549=float3(l9_543,0.0);
int l9_550=l9_545;
int l9_551=l9_548;
if (l9_550==1)
{
l9_549.y=((2.0*l9_549.y)+float(l9_551))-1.0;
}
float2 l9_552=l9_549.xy;
l9_544=l9_552;
}
else
{
...
float2 l9_553=l9_544;
float2 l9_554=l9_553;
float2 l9_555=l9_554;
float2 l9_556=l9_555;
float l9_557=0.0;
int l9_558;
...
int l9_565=sc_ScreenTextureLayout_tmp;
int l9_566=l9_563;
float l9_567=l9_557;
...
float4 l9_574=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_573.xy,bias(l9_567));
float4 l9_575=l9_574;
float4 l9_576=l9_575;
l9_539=l9_576;
}
float4 l9_577=l9_539;
float3 l9_578=l9_577.xyz;
float3 l9_579=l9_578;
float3 l9_580=l9_537.xyz;
float3 l9_581=definedBlend(l9_579,l9_580,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_538=float4(l9_581.x,l9_581.y,l9_581.z,l9_538.w);
float3 l9_582=mix(l9_578,l9_538.xyz,float3(l9_537.w));
l9_538=float4(l9_582.x,l9_582.y,l9_582.z,l9_538.w);
l9_538.w=1.0;
float4 l9_583=l9_538;
param_22=l9_583;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_584=float4(in.varScreenPos.xyz,1.0);
param_22=l9_584;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_585=gl_FragCoord;
float l9_586=fast::clamp(abs(l9_585.z),0.0,1.0);
float4 l9_587=float4(l9_586,1.0-l9_586,1.0,1.0);
param_22=l9_587;
}
else
{
float4 l9_588=param_22;
float4 l9_589=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_589=float4(mix(float3(1.0),l9_588.xyz,float3(l9_588.w)),l9_588.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_590=l9_588.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_590=fast::clamp(l9_590,0.0,1.0);
}
l9_589=float4(l9_588.xyz*l9_590,l9_590);
}
else
{
l9_589=l9_588;
...
float4 l9_595=param_24;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_595.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_595;
return out;
}
} // FRAGMENT SHADER
