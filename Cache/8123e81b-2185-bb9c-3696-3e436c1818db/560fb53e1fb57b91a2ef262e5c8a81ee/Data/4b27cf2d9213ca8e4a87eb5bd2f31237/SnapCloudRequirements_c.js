...
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Centralized Supabase project settings for all Snap Cloud examples</span>"}
// @input Asset.SupabaseProject supabaseProject {"hint":"SupabaseProject asset from Asset Browser (created via Supabase Plugin)"}
// @ui {"widget":"separator"}
// @ui {"widget":"label", "label":"<span style=\"color: #60A5FA;\">Warning & Debug Settings</span>"}
// @ui {"widget":"label", "label":"<span style=\"color: #94A3B8; font-size: 11px;\">Configure warning display and debug logging options</span>"}
...
var Module = require("../../../../Modules/Src/Packages/SnapCloudExamples.lspkg/SnapCloudRequirements");
