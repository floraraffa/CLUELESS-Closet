...
#endif
sc_writeFragData0(max(l9_190,vec4(0.0)));
return;
}
vec4 l9_192;
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_222-0.0039215689)),min(1.0,l9_222+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_224),packValue(l9_224),packValue(l9_224),packValue(l9_224)));
}
#endif
}
#else
