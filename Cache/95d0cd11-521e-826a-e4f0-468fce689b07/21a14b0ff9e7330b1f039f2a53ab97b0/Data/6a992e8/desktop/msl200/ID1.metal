...
//sampler sampler Tweak_N27SmpSC 0:25
//sampler sampler intensityTextureSmpSC 0:26
//sampler sampler patternTextureId01SmpSC 0:27
...
//texture texture2D Tweak_N27 0:5:0:25
//texture texture2D intensityTexture 0:6:0:26
//texture texture2D patternTextureId01 0:7:0:27
...
//}
//ubo int UserUniforms 0:37:5120 {
//float4 sc_Time 1376
...
//float Tweak_N1 4384
//float3x3 Tweak_N25Transform 4448
//float4 Tweak_N25UvMinMax 4496
//float4 Tweak_N25BorderColor 4512
//float3x3 Tweak_N27Transform 4576
//float4 Tweak_N27UvMinMax 4624
//float4 Tweak_N27BorderColor 4640
//bool rimOnOffId01 4656
//float rimExpId01 4660
//float rimIntId01 4664
//bool patternOnOffId01 4668
//float4 patternColorId01 4672
//bool pngPatternId01 4688
//float3x3 patternTextureId01Transform 4752
//float4 patternTextureId01UvMinMax 4800
//float4 patternTextureId01BorderColor 4816
//float2 patternScaleId01 4832
//float2 patternOffsetId01 4840
//float patternRotateId01 4848
//float4 colorId01 4864
//float Tweak_N47 4880
//float3 Port_Import_N009 4896
//float2 Port_Center_N122 4912
//float2 Port_Center_N126 4920
//float4 Port_Input1_N138 4928
//float4 Port_Input1_N051 4960
//float4 Port_Input2_N051 4976
//float4 Port_Input0_N102 4992
//float Port_Import_N060 5024
//float4 Port_Input1_N062 5040
//float Port_Import_N063 5056
//float Port_Import_N100 5060
//float4 Port_Input1_N070 5072
//float4 Port_Input2_N070 5088
//float depthRef 5104
//}
...
//spec_const bool SC_USE_UV_MIN_MAX_patternTextureId01 38 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N25 39 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N27 40 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 41 0
//spec_const bool SC_USE_UV_TRANSFORM_patternTextureId01 42 0
//spec_const bool Tweak_N25HasSwappedViews 43 0
//spec_const bool Tweak_N27HasSwappedViews 44 0
//spec_const bool UseViewSpaceDepthVariant 45 1
//spec_const bool intensityTextureHasSwappedViews 46 0
//spec_const bool patternTextureId01HasSwappedViews 47 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N25 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N27 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_patternTextureId01 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N25 83 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N27 84 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 85 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_patternTextureId01 86 -1
//spec_const int Tweak_N25Layout 87 0
//spec_const int Tweak_N27Layout 88 0
//spec_const int intensityTextureLayout 89 0
//spec_const int patternTextureId01Layout 90 0
...
constant bool SC_USE_UV_MIN_MAX_patternTextureId01 [[function_constant(38)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N27 [[function_constant(40)]];
...
constant bool SC_USE_UV_TRANSFORM_patternTextureId01 [[function_constant(42)]];
...
constant bool Tweak_N27HasSwappedViews [[function_constant(44)]];
...
constant bool patternTextureId01HasSwappedViews [[function_constant(47)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N27 [[function_constant(80)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_patternTextureId01 [[function_constant(82)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N27 [[function_constant(84)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_patternTextureId01 [[function_constant(86)]];
...
constant int Tweak_N27Layout [[function_constant(88)]];
...
constant int patternTextureId01Layout [[function_constant(90)]];
...
sampler Tweak_N27SmpSC [[id(25)]];
sampler intensityTextureSmpSC [[id(26)]];
sampler patternTextureId01SmpSC [[id(27)]];
...
Output_N15=Export_N14*Output_N52;
float4 Result_N245=float4(0.0);
float param_28=0.0;
float4 param_29=float4(0.0);
float4 param_30=float4(0.0);
ssGlobals param_32=Globals;
float l9_165=0.0;
float l9_166=float((*sc_set0.UserUniforms).rimOnOffId01!=0);
l9_165=l9_166;
param_28=l9_165;
float4 param_31;
if ((param_28*1.0)!=0.0)
{
float l9_167=0.0;
float l9_168=(*sc_set0.UserUniforms).rimExpId01;
l9_167=l9_168;
float l9_169=0.0;
float l9_170=(*sc_set0.UserUniforms).rimIntId01;
l9_169=l9_170;
float l9_171=0.0;
float l9_172=l9_167;
float l9_173=l9_169;
ssGlobals l9_174=param_32;
float l9_175=abs(dot(-l9_174.ViewDirWS,l9_174.VertexNormal_WorldSpace));
float l9_176=1.0-pow(1.0-l9_175,l9_172);
l9_176=fast::max(l9_176,0.0);
l9_176*=l9_173;
l9_171=l9_176;
...
ssGlobals l9_181=param_32;
float l9_182=0.0;
float l9_183=float((*sc_set0.UserUniforms).patternOnOffId01!=0);
l9_182=l9_183;
l9_178=l9_182;
float4 l9_184;
if ((l9_178*1.0)!=0.0)
...
float4 l9_186=(*sc_set0.UserUniforms).patternColorId01;
l9_185=l9_186;
float4 l9_187=float4(0.0);
float l9_188=0.0;
float4 l9_189=float4(0.0);
float4 l9_190=float4(0.0);
ssGlobals l9_191=l9_181;
float l9_192=0.0;
float l9_193=float((*sc_set0.UserUniforms).pngPatternId01!=0);
l9_192=l9_193;
l9_188=l9_192;
float4 l9_194;
if ((l9_188*1.0)!=0.0)
...
l9_195=l9_191.Surface_UVCoord0;
float2 l9_196=float2(0.0);
float2 l9_197=(*sc_set0.UserUniforms).patternScaleId01;
l9_196=l9_197;
float2 l9_198=float2(0.0);
l9_198=((l9_195-(*sc_set0.UserUniforms).Port_Center_N122)*l9_196)+(*sc_set0.UserUniforms).Port_Center_N122;
float2 l9_199=float2(0.0);
float2 l9_200=(*sc_set0.UserUniforms).patternOffsetId01;
l9_199=l9_200;
float2 l9_201=float2(0.0);
l9_201=l9_198+l9_199;
float l9_202=0.0;
float l9_203=(*sc_set0.UserUniforms).patternRotateId01;
l9_202=l9_203;
float2 l9_204=float2(0.0);
float2 l9_205=l9_201;
float l9_206=l9_202;
float2 l9_207=(*sc_set0.UserUniforms).Port_Center_N126;
float l9_208=sin(radians(l9_206));
float l9_209=cos(radians(l9_206));
float2 l9_210=l9_205-l9_207;
l9_210=float2(dot(float2(l9_209,l9_208),l9_210),dot(float2(-l9_208,l9_209),l9_210))+l9_207;
l9_204=l9_210;
...
int l9_217=l9_212;
int l9_218=patternTextureId01Layout_tmp;
int l9_219=l9_217;
float2 l9_220=l9_204;
bool l9_221=(int(SC_USE_UV_TRANSFORM_patternTextureId01_tmp)!=0);
float3x3 l9_222=(*sc_set0.UserUniforms).patternTextureId01Transform;
int2 l9_223=int2(SC_SOFTWARE_WRAP_MODE_U_patternTextureId01_tmp,SC_SOFTWARE_WRAP_MODE_V_patternTextureId01_tmp);
bool l9_224=(int(SC_USE_UV_MIN_MAX_patternTextureId01_tmp)!=0);
float4 l9_225=(*sc_set0.UserUniforms).patternTextureId01UvMinMax;
bool l9_226=(int(SC_USE_CLAMP_TO_BORDER_patternTextureId01_tmp)!=0);
float4 l9_227=(*sc_set0.UserUniforms).patternTextureId01BorderColor;
float l9_228=0.0;
...
float4 l9_295=sc_set0.patternTextureId01.sample(sc_set0.patternTextureId01SmpSC,l9_294.xy,bias(l9_288));
...
l9_298=l9_191.Surface_UVCoord0;
float2 l9_299=float2(0.0);
float2 l9_300=(*sc_set0.UserUniforms).patternScaleId01;
l9_299=l9_300;
float2 l9_301=float2(0.0);
l9_301=((l9_298-(*sc_set0.UserUniforms).Port_Center_N122)*l9_299)+(*sc_set0.UserUniforms).Port_Center_N122;
float2 l9_302=float2(0.0);
float2 l9_303=(*sc_set0.UserUniforms).patternOffsetId01;
l9_302=l9_303;
float2 l9_304=float2(0.0);
l9_304=l9_301+l9_302;
float l9_305=0.0;
float l9_306=(*sc_set0.UserUniforms).patternRotateId01;
l9_305=l9_306;
float2 l9_307=float2(0.0);
float2 l9_308=l9_304;
float l9_309=l9_305;
float2 l9_310=(*sc_set0.UserUniforms).Port_Center_N126;
float l9_311=sin(radians(l9_309));
float l9_312=cos(radians(l9_309));
float2 l9_313=l9_308-l9_310;
l9_313=float2(dot(float2(l9_312,l9_311),l9_313),dot(float2(-l9_311,l9_312),l9_313))+l9_310;
l9_307=l9_313;
...
int l9_320=l9_315;
int l9_321=patternTextureId01Layout_tmp;
int l9_322=l9_320;
float2 l9_323=l9_307;
bool l9_324=(int(SC_USE_UV_TRANSFORM_patternTextureId01_tmp)!=0);
float3x3 l9_325=(*sc_set0.UserUniforms).patternTextureId01Transform;
int2 l9_326=int2(SC_SOFTWARE_WRAP_MODE_U_patternTextureId01_tmp,SC_SOFTWARE_WRAP_MODE_V_patternTextureId01_tmp);
bool l9_327=(int(SC_USE_UV_MIN_MAX_patternTextureId01_tmp)!=0);
float4 l9_328=(*sc_set0.UserUniforms).patternTextureId01UvMinMax;
bool l9_329=(int(SC_USE_CLAMP_TO_BORDER_patternTextureId01_tmp)!=0);
float4 l9_330=(*sc_set0.UserUniforms).patternTextureId01BorderColor;
float l9_331=0.0;
...
float4 l9_398=sc_set0.patternTextureId01.sample(sc_set0.patternTextureId01SmpSC,l9_397.xy,bias(l9_391));
...
l9_314=l9_400;
float l9_401=0.0;
float3 l9_402=l9_314.xyz;
float l9_403=l9_402.x;
l9_401=l9_403;
l9_190=float4(l9_401);
l9_194=l9_190;
}
l9_187=l9_194;
float4 l9_404=float4(0.0);
l9_404=l9_185*l9_187;
l9_179=l9_404;
l9_184=l9_179;
}
else
...
float4 l9_406=(*sc_set0.UserUniforms).colorId01;
l9_405=l9_406;
l9_180=l9_405;
l9_184=l9_180;
}
...
l9_407=l9_177*(*sc_set0.UserUniforms).Port_Input1_N138;
float4 l9_408=float4(0.0);
float4 l9_409=(*sc_set0.UserUniforms).colorId01;
l9_408=l9_409;
...
float3 l9_415=l9_413.xyz*l9_413.w;
l9_413=float4(l9_415.x,l9_415.y,l9_415.z,l9_413.w);
float4 l9_416=l9_413+(l9_414*(1.0-l9_413.w));
l9_410=l9_416;
float4 l9_417=float4(0.0);
l9_417=float4(l9_171)*l9_410;
float4 l9_418=float4(0.0);
l9_418=l9_417+l9_410;
param_29=l9_418;
param_31=param_29;
}
else
...
ssGlobals l9_423=param_32;
float l9_424=0.0;
float l9_425=float((*sc_set0.UserUniforms).patternOnOffId01!=0);
l9_424=l9_425;
l9_420=l9_424;
float4 l9_426;
if ((l9_420*1.0)!=0.0)
...
float4 l9_428=(*sc_set0.UserUniforms).patternColorId01;
l9_427=l9_428;
float4 l9_429=float4(0.0);
float l9_430=0.0;
float4 l9_431=float4(0.0);
float4 l9_432=float4(0.0);
ssGlobals l9_433=l9_423;
float l9_434=0.0;
float l9_435=float((*sc_set0.UserUniforms).pngPatternId01!=0);
l9_434=l9_435;
l9_430=l9_434;
float4 l9_436;
if ((l9_430*1.0)!=0.0)
...
l9_437=l9_433.Surface_UVCoord0;
float2 l9_438=float2(0.0);
float2 l9_439=(*sc_set0.UserUniforms).patternScaleId01;
l9_438=l9_439;
float2 l9_440=float2(0.0);
l9_440=((l9_437-(*sc_set0.UserUniforms).Port_Center_N122)*l9_438)+(*sc_set0.UserUniforms).Port_Center_N122;
float2 l9_441=float2(0.0);
float2 l9_442=(*sc_set0.UserUniforms).patternOffsetId01;
l9_441=l9_442;
float2 l9_443=float2(0.0);
l9_443=l9_440+l9_441;
float l9_444=0.0;
float l9_445=(*sc_set0.UserUniforms).patternRotateId01;
l9_444=l9_445;
float2 l9_446=float2(0.0);
float2 l9_447=l9_443;
float l9_448=l9_444;
float2 l9_449=(*sc_set0.UserUniforms).Port_Center_N126;
float l9_450=sin(radians(l9_448));
float l9_451=cos(radians(l9_448));
float2 l9_452=l9_447-l9_449;
l9_452=float2(dot(float2(l9_451,l9_450),l9_452),dot(float2(-l9_450,l9_451),l9_452))+l9_449;
l9_446=l9_452;
...
int l9_459=l9_454;
int l9_460=patternTextureId01Layout_tmp;
int l9_461=l9_459;
float2 l9_462=l9_446;
bool l9_463=(int(SC_USE_UV_TRANSFORM_patternTextureId01_tmp)!=0);
float3x3 l9_464=(*sc_set0.UserUniforms).patternTextureId01Transform;
int2 l9_465=int2(SC_SOFTWARE_WRAP_MODE_U_patternTextureId01_tmp,SC_SOFTWARE_WRAP_MODE_V_patternTextureId01_tmp);
bool l9_466=(int(SC_USE_UV_MIN_MAX_patternTextureId01_tmp)!=0);
float4 l9_467=(*sc_set0.UserUniforms).patternTextureId01UvMinMax;
bool l9_468=(int(SC_USE_CLAMP_TO_BORDER_patternTextureId01_tmp)!=0);
float4 l9_469=(*sc_set0.UserUniforms).patternTextureId01BorderColor;
float l9_470=0.0;
...
float4 l9_537=sc_set0.patternTextureId01.sample(sc_set0.patternTextureId01SmpSC,l9_536.xy,bias(l9_530));
...
l9_540=l9_433.Surface_UVCoord0;
float2 l9_541=float2(0.0);
float2 l9_542=(*sc_set0.UserUniforms).patternScaleId01;
l9_541=l9_542;
float2 l9_543=float2(0.0);
l9_543=((l9_540-(*sc_set0.UserUniforms).Port_Center_N122)*l9_541)+(*sc_set0.UserUniforms).Port_Center_N122;
float2 l9_544=float2(0.0);
float2 l9_545=(*sc_set0.UserUniforms).patternOffsetId01;
l9_544=l9_545;
float2 l9_546=float2(0.0);
l9_546=l9_543+l9_544;
float l9_547=0.0;
float l9_548=(*sc_set0.UserUniforms).patternRotateId01;
l9_547=l9_548;
float2 l9_549=float2(0.0);
float2 l9_550=l9_546;
float l9_551=l9_547;
float2 l9_552=(*sc_set0.UserUniforms).Port_Center_N126;
float l9_553=sin(radians(l9_551));
float l9_554=cos(radians(l9_551));
float2 l9_555=l9_550-l9_552;
l9_555=float2(dot(float2(l9_554,l9_553),l9_555),dot(float2(-l9_553,l9_554),l9_555))+l9_552;
l9_549=l9_555;
...
int l9_562=l9_557;
int l9_563=patternTextureId01Layout_tmp;
int l9_564=l9_562;
float2 l9_565=l9_549;
bool l9_566=(int(SC_USE_UV_TRANSFORM_patternTextureId01_tmp)!=0);
float3x3 l9_567=(*sc_set0.UserUniforms).patternTextureId01Transform;
int2 l9_568=int2(SC_SOFTWARE_WRAP_MODE_U_patternTextureId01_tmp,SC_SOFTWARE_WRAP_MODE_V_patternTextureId01_tmp);
bool l9_569=(int(SC_USE_UV_MIN_MAX_patternTextureId01_tmp)!=0);
float4 l9_570=(*sc_set0.UserUniforms).patternTextureId01UvMinMax;
bool l9_571=(int(SC_USE_CLAMP_TO_BORDER_patternTextureId01_tmp)!=0);
float4 l9_572=(*sc_set0.UserUniforms).patternTextureId01BorderColor;
float l9_573=0.0;
bool l9_574=l9_571&&(!l9_569);
float l9_575=1.0;
float l9_576=l9_565.x;
int l9_577=l9_568.x;
if (l9_577==1)
{
l9_576=fract(l9_576);
...
if (l9_582==2)
{
float l9_583=fract(l9_581);
float l9_584=l9_581-l9_583;
float l9_585=step(0.25,fract(l9_584*0.5));
l9_581=mix(l9_583,1.0-l9_583,fast::clamp(l9_585,0.0,1.0));
}
}
l9_565.y=l9_581;
if (l9_569)
...
float l9_588=l9_565.x;
float l9_589=l9_570.x;
float l9_590=l9_570.z;
bool l9_591=l9_587;
float l9_592=l9_575;
...
float l9_597=l9_565.y;
float l9_598=l9_570.y;
float l9_599=l9_570.w;
bool l9_600=l9_596;
float l9_601=l9_575;
...
float2 l9_604=l9_565;
bool l9_605=l9_566;
float3x3 l9_606=l9_567;
if (l9_605)
{
l9_604=float2((l9_606*float3(l9_604,1.0)).xy);
}
float2 l9_607=l9_604;
l9_565=l9_607;
float l9_608=l9_565.x;
int l9_609=l9_568.x;
bool l9_610=l9_574;
float l9_611=l9_575;
...
int l9_635=l9_631;
int l9_636=l9_632;
float3 l9_637=float3(0.0);
if (l9_635==0)
{
l9_637=float3(l9_634,0.0);
}
else
{
if (l9_635==1)
{
l9_637=float3(l9_634.x,(l9_634.y*0.5)+(0.5-(float(l9_636)*0.5)),0.0);
}
else
{
l9_637=float3(l9_634,float(l9_636));
}
}
float3 l9_638=l9_637;
float3 l9_639=l9_638;
float4 l9_640=sc_set0.patternTextureId01.sample(sc_set0.patternTextureId01SmpSC,l9_639.xy,bias(l9_633));
float4 l9_641=l9_640;
if (l9_571)
{
l9_641=mix(l9_572,l9_641,float4(l9_575));
}
float4 l9_642=l9_641;
l9_556=l9_642;
float l9_643=0.0;
float3 l9_644=l9_556.xyz;
float l9_645=l9_644.x;
l9_643=l9_645;
l9_432=float4(l9_643);
l9_436=l9_432;
}
l9_429=l9_436;
float4 l9_646=float4(0.0);
l9_646=l9_427*l9_429;
l9_421=l9_646;
l9_426=l9_421;
}
else
...
float4 l9_648=(*sc_set0.UserUniforms).colorId01;
l9_647=l9_648;
l9_422=l9_647;
l9_426=l9_422;
}
...
l9_649=l9_419*(*sc_set0.UserUniforms).Port_Input1_N138;
float4 l9_650=float4(0.0);
float4 l9_651=(*sc_set0.UserUniforms).colorId01;
l9_650=l9_651;
float4 l9_652=float4(0.0);
float4 l9_653=l9_649;
float4 l9_654=l9_650;
float4 l9_655=l9_653;
float4 l9_656=l9_654;
float3 l9_657=l9_655.xyz*l9_655.w;
l9_655=float4(l9_657.x,l9_657.y,l9_657.z,l9_655.w);
float4 l9_658=l9_655+(l9_656*(1.0-l9_655.w));
l9_652=l9_658;
param_30=l9_652;
param_31=param_30;
}
Result_N245=param_31;
float4 Output_N5=float4(0.0);
Output_N5=Output_N15+Result_N245;
...
float l9_659=dot(param_34.xyz,float3(0.29899999,0.58700001,0.114));
float4 param_36=float4(mix(float3(l9_659),param_34.xyz,float3(param_35)),param_34.w);
Output_N69=param_36;
...
float4 l9_663=fast::max(param_38,float4(0.0));
float4 param_39=l9_663;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_666=fast::clamp(l9_665.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_666=fast::clamp(dot(l9_665.xyz,float3(l9_665.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_666=(1.0-dot(l9_665.xyz,float3(0.33333001)))*l9_665.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_666=(1.0-fast::clamp(dot(l9_665.xyz,float3(1.0)),0.0,1.0))*l9_665.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_666=fast::clamp(dot(l9_665.xyz,float3(1.0)),0.0,1.0)*l9_665.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_666=fast::clamp(dot(l9_665.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_666=dot(l9_665.xyz,float3(0.33333001))*l9_665.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_666=1.0-fast::clamp(dot(l9_665.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_667=l9_666;
float l9_668=l9_667;
float l9_669=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_668;
float3 l9_670=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_664.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_671=float4(l9_670.x,l9_670.y,l9_670.z,l9_669);
param_40=l9_671;
}
else
{
...
{
float4 l9_672=param_40;
float4 l9_673=float4(0.0);
float4 l9_674=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_675=out.sc_FragData0;
l9_674=l9_675;
}
else
{
float4 l9_676=gl_FragCoord;
float2 l9_677=l9_676.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_678=l9_677;
...
int l9_682=l9_681;
int l9_683=l9_682;
float3 l9_684=float3(l9_678,0.0);
int l9_685=l9_680;
int l9_686=l9_683;
if (l9_685==1)
{
l9_684.y=((2.0*l9_684.y)+float(l9_686))-1.0;
}
float2 l9_687=l9_684.xy;
l9_679=l9_687;
}
else
{
...
int l9_698=l9_693;
float2 l9_699=l9_691;
int l9_700=sc_ScreenTextureLayout_tmp;
int l9_701=l9_698;
float l9_702=l9_692;
...
if (l9_704==0)
{
l9_706=float3(l9_703,0.0);
}
else
{
if (l9_704==1)
{
l9_706=float3(l9_703.x,(l9_703.y*0.5)+(0.5-(float(l9_705)*0.5)),0.0);
}
else
{
l9_706=float3(l9_703,float(l9_705));
}
}
float3 l9_707=l9_706;
float3 l9_708=l9_707;
float4 l9_709=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_708.xy,bias(l9_702));
float4 l9_710=l9_709;
float4 l9_711=l9_710;
l9_674=l9_711;
}
float4 l9_712=l9_674;
float3 l9_713=l9_712.xyz;
float3 l9_714=l9_713;
float3 l9_715=l9_672.xyz;
float3 l9_716=definedBlend(l9_714,l9_715,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_673=float4(l9_716.x,l9_716.y,l9_716.z,l9_673.w);
float3 l9_717=mix(l9_713,l9_673.xyz,float3(l9_672.w));
l9_673=float4(l9_717.x,l9_717.y,l9_717.z,l9_673.w);
l9_673.w=1.0;
float4 l9_718=l9_673;
param_40=l9_718;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_719=float4(in.varScreenPos.xyz,1.0);
param_40=l9_719;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_720=gl_FragCoord;
float l9_721=fast::clamp(abs(l9_720.z),0.0,1.0);
float4 l9_722=float4(l9_721,1.0-l9_721,1.0,1.0);
param_40=l9_722;
}
else
{
float4 l9_723=param_40;
float4 l9_724=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_724=float4(mix(float3(1.0),l9_723.xyz,float3(l9_723.w)),l9_723.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_725=l9_723.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_725=fast::clamp(l9_725,0.0,1.0);
}
l9_724=float4(l9_723.xyz*l9_725,l9_725);
}
else
{
l9_724=l9_723;
...
float4 l9_730=param_42;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_730.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_730;
return out;
}
} // FRAGMENT SHADER
