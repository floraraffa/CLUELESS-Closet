...
// @input Asset.AudioTrackAsset sfxPositiveProgress {"hint":"SFX: Style points+/Fashion Trust+ (same sound)"}
// @input Asset.AudioTrackAsset sfxNegativeProgress {"hint":"SFX: Fashion Trust- (same sound)"}
