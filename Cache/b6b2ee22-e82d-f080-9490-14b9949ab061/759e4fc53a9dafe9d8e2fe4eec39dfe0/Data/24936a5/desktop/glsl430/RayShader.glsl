...
uniform vec4 GradientColorA;
uniform vec4 GradientColorB;
uniform float GradientPointA;
uniform float GradientPointB;
uniform float opacity;
uniform float Port_RangeMinA_N062;
uniform float Port_RangeMaxA_N062;
uniform float Port_RangeMaxB_N062;
uniform float Port_RangeMinB_N062;
uniform vec2 Port_Import_N063;
uniform vec2 Port_Center_N065;
uniform float Port_Value1_N009;
...
vec2 l9_3=l9_1-vec2(Port_RangeMinA_N062);
vec2 l9_4=vec2(Port_Value1_N009,GradientPointA);
vec2 l9_5=vec2(Port_Value1_N012,GradientPointB)-l9_4;
vec4 l9_6=mix(GradientColorA,GradientColorB,vec4(smoothstep(Port_Input0_N086,Port_Input1_N086,clamp((dot(((((((l9_3/vec2((Port_RangeMaxA_N062-Port_RangeMinA_N062)+1e-06))*(Port_RangeMaxB_N062-Port_RangeMinB_N062))+vec2(Port_RangeMinB_N062))-Port_Center_N065)*Port_Import_N063)+Port_Center_N065)-l9_4,l9_5)/(dot(l9_5,l9_5)+1.234e-06))+0.001,Port_Input1_N083+0.001,Port_Input2_N083+0.001)-0.001)));
vec3 l9_7=vec3(l9_6.xyz);
float l9_8=opacity*l9_6.w;
...
{
l9_15=clamp(dot(l9_9.xyz,vec3(l9_8)),0.0,1.0);
}
#else
{
float l9_16;
...
{
l9_17=(1.0-dot(l9_9.xyz,vec3(0.33333001)))*l9_8;
}
#else
{
float l9_18;
...
{
l9_18=(1.0-clamp(dot(l9_9.xyz,vec3(1.0)),0.0,1.0))*l9_8;
}
#else
{
float l9_19;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_21=clamp(dot(l9_9.xyz,vec3(1.0)),0.0,1.0)*l9_8;
}
#else
{
float l9_22;
...
{
l9_22=dot(l9_9.xyz,vec3(0.33333001))*l9_8;
}
#else
{
float l9_23;
...
#endif
vec3 l9_30=mix(l9_27.xyz,definedBlend(l9_27.xyz,l9_9.xyz).xyz,vec3(l9_8));
