...
#endif
sc_writeFragData0(max(l9_244,vec4(0.0)));
return;
}
vec4 l9_246;
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_276-0.0039215689)),min(1.0,l9_276+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_278),packValue(l9_278),packValue(l9_278),packValue(l9_278)));
}
#endif
}
#else
...
sc_writeFragData0(l9_275);
}
#endif
}
#else
{
sc_writeFragData0(l9_274);
}
#endif
}
#endif
