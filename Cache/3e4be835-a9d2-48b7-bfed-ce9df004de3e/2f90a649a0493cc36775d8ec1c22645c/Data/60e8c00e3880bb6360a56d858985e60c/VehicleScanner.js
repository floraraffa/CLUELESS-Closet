...
exports.VehicleScanner = void 0;
var __selfType = requireType("./VehicleScanner");
...
let VehicleScanner = (() => {
    ...
    var VehicleScanner = _classThis = class extends _classSuper {
        constructor() {
            super();
            // =====================================================================
            // MODULES
...
Prefer direct camera captures of physical garments or outfits. If the image is only a screen, poster,
catalog page, advertisement, or non-clothing scene, return clothing_found false.
{
  "vehicle_found": false,
...
- Detect physical garments, outfits laid out on a surface, items on hangers, or clothing worn by a person.
...
- If no usable clothing is visible, return clothing_found false and brand_model "NO_CLOTHING".`;
            ...
            try {
                ...
                if (this.enableAntiCheat && parsed.rejection_reason) {
                    print('VehicleScanner: Scan rejected — ' + parsed.rejection_reason);
                ...
                parsed.scan_context = (0, VehicleTypes_1.normalizeScanContext)(parsed.scan_context);
                ...
                parsed.top_speed = (0, VehicleTypes_1.clampStat)(parsed.top_speed);
                parsed.acceleration = (0, VehicleTypes_1.clampStat)(parsed.acceleration);
                parsed.braking = (0, VehicleTypes_1.clampStat)(parsed.braking);
                parsed.traction = (0, VehicleTypes_1.clampStat)(parsed.traction);
                parsed.comfort = (0, VehicleTypes_1.clampStat)(parsed.comfort);
                parsed.rarity = (0, VehicleTypes_1.clampStat)(parsed.rarity || 2);
                parsed.rarity_label = (0, VehicleTypes_1.getRarityLabel)(parsed.rarity);
                print('VehicleScanner: Clothing: ' + parsed.brand_model +
    ...
    __setFunctionName(_classThis, "VehicleScanner");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        VehicleScanner = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return VehicleScanner = _classThis;
})();
exports.VehicleScanner = VehicleScanner;
//# sourceMappingURL=VehicleScanner.js.map