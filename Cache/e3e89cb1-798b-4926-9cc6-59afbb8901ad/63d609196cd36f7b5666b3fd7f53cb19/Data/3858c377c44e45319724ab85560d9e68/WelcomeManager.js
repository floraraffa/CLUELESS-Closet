...
let WelcomeManager = (() => {
    ...
    var WelcomeManager = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.connectedLensButtonText = this.connectedLensButtonText;
            this.soloButton = this.soloButton;
            this.connectedLensButton = this.connectedLensButton;
            // =====================================================================
            // CALLBACKS — Set by orchestrator
            // =====================================================================
            this.onSoloModeSelected = null;
            this.onConnectedLensModeSelected = null;
        ...
        onAwake() {
            ...
            if (this.connectedLensButton)
                this.connectedLensButton.enabled = false;
        ...
        applyWelcomeTranslations() {
            ...
            if (this.connectedLensButtonText)
                this.connectedLensButtonText.text = (0, Localization_1.t)('connected_lens');
        }
        // =====================================================================
        // BUTTON SETUP
        // =====================================================================
        setupButtons() {
            ...
            this.connectButtonWithPolling(this.connectedLensButton, () => {
                ...
                this.hide();
                if (this.onConnectedLensModeSelected)
                    this.onConnectedLensModeSelected();
            }, 'SharedClosetButton');
