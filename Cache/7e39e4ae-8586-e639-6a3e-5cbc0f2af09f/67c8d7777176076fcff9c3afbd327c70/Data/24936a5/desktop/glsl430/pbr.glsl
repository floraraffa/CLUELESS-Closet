...
vec2 l9_2=((varTex01.xy-Port_Center_N016)*vec2(uvScale))+Port_Center_N016;
vec4 l9_3;
#if (baseTexLayout==2)
{
...
#endif
uvec3 l9_152=uvec3(round((varPosAndMotion.xyz-sc_RayTracingOriginOffset)*sc_RayTracingOriginScale));
...
#endif
sc_writeFragData0(max(l9_167,vec4(0.0)));
return;
}
vec4 l9_169;
#if (sc_ProjectiveShadowsCaster)
