...
exports.VehicleNarrator = void 0;
var __selfType = requireType("./VehicleNarrator");
...
let VehicleNarrator = (() => {
    ...
    var VehicleNarrator = _classThis = class extends _classSuper {
        constructor() {
            super();
            // =====================================================================
            // INPUTS
        ...
        triggerReview(data, cardReviewText) {
            if (this.isFetchingInfo) {
                if (cardReviewText) {
                    ...
                    if (obj)
                        obj.enabled = true;
                    cardReviewText.text = (0, Localization_1.t)('review_in_progress');
                }
                else {
                    this.showDescriptionText((0, Localization_1.t)('review_in_progress'));
                }
                return;
            }
        ...
        async fetchVehicleDescription(vehicleName, vehicleType, brand) {
...
${langInstruction}`;
    ...
    __setFunctionName(_classThis, "VehicleNarrator");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        VehicleNarrator = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return VehicleNarrator = _classThis;
})();
exports.VehicleNarrator = VehicleNarrator;
//# sourceMappingURL=VehicleNarrator.js.map