    ...
    var XPManager = _classThis = class extends _classSuper {
        ...
        rewardTrust() {
            ...
            if (this.profile.trustScore < 100) {
                ...
                print('XPManager: Trust reward +' + ClosetTypes_1.TRUST_SCAN_REWARD + ' → ' + this.profile.trustScore + '%');
        ...
        refreshUserCardUI() {
            ...
            const prestigeStr = (0, ClosetTypes_1.formatPrestigeStars)(this.profile.prestige);
            ...
            if (this.bonusInfoText) {
                const mult = (0, ClosetTypes_1.getStreakMultiplier)(this.profile.streakDays);
                let bonusText = '';
