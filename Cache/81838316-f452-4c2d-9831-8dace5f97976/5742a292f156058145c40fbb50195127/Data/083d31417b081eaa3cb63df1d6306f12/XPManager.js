...
let XPManager = (() => {
    ...
    var XPManager = _classThis = class extends _classSuper {
        ...
        onAwake() {
            ...
            this.createEvent('OnStartEvent').bind(() => {
                ...
                print('XPManager: Profile loaded — Style ' + this.profile.level
                    ...
                    + ' | Style Score ' + this.profile.trustScore + '%');
            });
        }
        // =====================================================================
        // PUBLIC API
        ...
        penalizeTrust() {
            ...
            print('XPManager: Style Score penalty -' + penalty
        ...
        rewardTrust() {
            ...
            if (this.profile.trustScore < 100) {
                ...
                print('XPManager: Style Score reward +' + ClosetTypes_1.TRUST_SCAN_REWARD + ' → ' + this.profile.trustScore + '%');
        ...
        getTrustDisplayString() {
            ...
            return name + '\n' + rank.name + ' | ' + (0, ClosetTypes_1.formatTrustText)(this.profile.trustScore);
        }
        /** Returns a compact trust string for the User Card Info. */
        getTrustCardString() {
            const rank = (0, ClosetTypes_1.getTrustRank)(this.profile.trustScore);
            return rank.name + '\n' + (0, ClosetTypes_1.formatTrustText)(this.profile.trustScore);
        }
        getDisplayName() {
        ...
        buildWelcomeGreetingMessage() {
            ...
            const mult = (0, ClosetTypes_1.getStreakMultiplier)(days);
            if (days >= 3) {
                return (0, Localization_1.tf)('streak_bonus_long', { name: this.getDisplayName(), days: days, mult: mult.toFixed(1) });
            }
            if (days === 2) {
                return (0, Localization_1.tf)('streak_bonus_short', { name: this.getDisplayName(), mult: mult.toFixed(1) });
            }
            return (0, Localization_1.tf)('welcome_user', { name: this.getDisplayName() }) + '\n' + (0, Localization_1.t)('daily_bonus_none');
        }
        migrateOldTrust() {
            try {
        ...
        refreshUserCardUI() {
            ...
            if (this.levelNumberText) {
                this.levelNumberText.text = (0, Localization_1.tf)('welcome_user', { name: this.getDisplayName() });
                this.forceTextBlack(this.levelNumberText);
                const textObj = this.levelNumberText.getSceneObject();
                if (textObj)
                    textObj.enabled = true;
            }
            // XP Counter slot: daily consecutive-day bonus
            if (this.xpCounterText) {
                this.xpCounterText.text = this.getDailyBonusText();
        ...
        showWelcomePopupAnimation(message) {
            ...
            this.forceTextBlack(this.xpDisplay);
