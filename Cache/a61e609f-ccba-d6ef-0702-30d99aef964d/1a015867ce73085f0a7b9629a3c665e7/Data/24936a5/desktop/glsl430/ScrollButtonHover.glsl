...
#endif
sc_writeFragData0(max(l9_199,vec4(0.0)));
return;
}
vec4 l9_201;
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_231-0.0039215689)),min(1.0,l9_231+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_233),packValue(l9_233),packValue(l9_233),packValue(l9_233)));
}
#endif
}
#else
