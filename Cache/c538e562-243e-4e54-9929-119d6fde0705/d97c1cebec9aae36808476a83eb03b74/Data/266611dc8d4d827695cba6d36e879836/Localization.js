...
const S = {
    ...
    // Welcome Container
    // -----------------------------------------------------------------
    welcome_title: { en: 'Scan your outfits in front of a mirror, or just your individual clothes.', fr: 'Scannez vos tenues devant un miroir, ou seulement vos vetements.', es: 'Escanea tus outfits frente a un espejo, o solo tus prendas individuales.' },
    welcome_description: {
