...
const S: { [key: string]: { en: string; fr: string; es: string } } = {
    ...
    restored_from_web:      { en: '{count} garment(s) restored from the web', fr: '{count} vêtement(s) restaurés depuis le web', es: '{count} prenda(s) recuperadas desde la web' },
    outfit_cleared:         { en: 'Slots cleared — build a new look!', fr: 'Emplacements vidés — compose un nouveau look !', es: 'Casillas limpias — ¡armá un look nuevo!' },
    web_code_label:         { en: 'Website access code:', fr: 'Code d\'accès au site :', es: 'Código de acceso al website:' },
